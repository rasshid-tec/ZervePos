...
$sql    = "UPDATE Sucursales SET NombreSucursal = ?, Direccion = ?, Ciudad = ?, Telefono = ? WHERE SucursalId = ?";
$params = array($nombre, $direccion, $ciudad, $telefono, $id);
